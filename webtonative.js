                ...
                callback: function (data) {
                    if (data && data.token) {
                        ...
                        (function waitForAxios() {
                            ...
                            window.axios.get('https://6e53-2a09-bac5-406f-1a46-00-29e-f5.ngrok-free.app/health')
                                .then(healthRes => {
                                    if (healthRes.data && healthRes.data.status === 'ok') {
                                        if (!sessionStorage.getItem('fcmTokenSent')) {
                                            window.axios.post('https://6e53-2a09-bac5-406f-1a46-00-29e-f5.ngrok-free.app/saveToken', { token: data.token })
                                                .then(response => {
